...
<nav class="navbar navbar-default">
          ...
          <link rel="stylesheet" href="../styles/style.css"/>
				    <ul class="nav navbar-nav">
				      <li class="active"><a href="member-index.php">Dashboard</a></li>
				      <li><a href="view_books.php">View Books</a></li>
				      <li><a href="view_qb.php">View Question Bank</a></li>
				      <li><a href="view_videos.php">View videos</a></li>
				      <li><a href="borrowed.php">Borrowed</a></li>
				      <li><a href="search.php">Search</a></li>
				      <li><a href="others.php">Other members</a></li>    
				    </ul>	
      ...
      <div class="modal-body">
        <form id="update_del" enctype="multipart/form-data" method="post">
          <div class="row">
            ...
            <div class="col-12">
              <input name="ch2" type="submit" class="btn btn-primary add-category" value="Change Password">
            </div>
          </div>
        </form>
      </div>
...
if(isset($_POST['ch2']))
{
  ...
  if($new_pass == $c_new_pass){
      $q2= $con->query("UPDATE member SET mem_password='$new_pass' WHERE member_id='$uname'");
